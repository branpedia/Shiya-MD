let handler = async (m, { conn }) => {
  ...
  if (m.sender.startsWith('62') || m.sender.startsWith('+62')) {
    var txt = `
(Indonesian)
**Ketentuan Layanan (TOS) - Shiya-MD ESM**
Dengan menggunakan Shiya-MD ESM, Anda setuju dengan ketentuan berikut:
...
Dengan menggunakan Shiya-MD ESM, Anda setuju dengan semua ketentuan yang berlaku.
...
`
    ...
    txt = `
(English)
**Term of Service (TOS) - Shiya-MD ESM**
By using Shiya-MD ESM, you agree to the following terms:
...
By using Shiya-MD ESM, you agree to abide by all applicable terms.
